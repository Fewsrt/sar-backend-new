const { createCar, findCarById, updateCarById, deleteCarById, findCarsByMonth, findCarsByYear, removeCarsByMonth, removeCarsByYear, getStatistics, findAllCars, findCarByCode, permanentDeleteCarById } = require('../../models/car.js');
...
module.exports = { addCar, getCar, updateCar, deleteCar, getCarsByMonth, getCarsByYear, deleteCarsByMonth, deleteCarsByYear, getCarStats, getAllCars, getCarByCode, permanentDeleteCar };